...
@Repository
public class AiOzoneInitDAOImpl implements IAiProcessInitDAO
{
    @Autowired
    ...
    {
        String strQuery = "SELECT * FROM ai_ozone_init";
    ...
    {
        String strQuery = "SELECT * FROM ai_ozone_init WHERE item=?";
        try
        {
    ...
    {
        String strQuery = "UPDATE ai_ozone_init SET value=? WHERE item='io_operation_mode'";
    ...
    {
        String strQuery = "UPDATE ai_ozone_init SET value=? WHERE item=?";
