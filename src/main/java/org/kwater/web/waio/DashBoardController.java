...
@Slf4j
@RestController
//@RequestMapping(value = "/waio", produces = "application/vnd.api.v1+json")
...
//        aiReceivingInfo.put("update_time", 1);
        aiReceivingInfo.put("id", 1);
        aiReceivingInfo.put("brnd", "Ford");
        aiReceivingInfo.put("model", "Mustang");
        aiReceivingInfo.put("color", "Red");
