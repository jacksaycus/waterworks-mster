...
@Repository
public class AiDisinfectionInitDAOImpl implements IAiProcessInitDAO
{
    @Autowired
    ...
    {
        String strQuery = "SELECT * FROM ai_disinfection_init";
    ...
    {
        String strQuery = "SELECT * FROM ai_disinfection_init WHERE item=?";
        try
        {
    ...
    {
        String strQuery = "UPDATE ai_disinfection_init SET value=? WHERE item='g_operation_mode'";
    ...
    {
        String strQuery = "UPDATE ai_disinfection_init SET value=? WHERE item=?";
