...
public class AiCoagulantRealtimeDAOImpl implements IAiCoagulantRealtimeDAO
{
    ...
    @Override
    public List<AiCoagulantRealtimeDTO> select(Date start_time, Date end_time)
    {
        String strQuery = "SELECT * FROM ai_coagulant_realtime " +
    ...
    @Override
    public AiCoagulantRealtimeDTO select()
    {
        String strQuery = "SELECT * FROM ai_coagulant_realtime ORDER BY update_time DESC LIMIT 1";
        try
        {
    ...
    {
        String strQuery = "DELETE FROM ai_coagulant_realtime WHERE update_time < ?";
