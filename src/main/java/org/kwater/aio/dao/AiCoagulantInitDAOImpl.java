...
@Repository
public class AiCoagulantInitDAOImpl implements IAiProcessInitDAO
{
    @Autowired
    ...
    {
        String strQuery = "SELECT * FROM ai_coagulant_init";
    ...
    {
        String strQuery = "SELECT * FROM ai_coagulant_init WHERE item=?";
        try
        {
    ...
    {
        String strQuery = "UPDATE ai_coagulant_init SET value=? WHERE item='c_operation_mode'";
    ...
    {
        String strQuery = "UPDATE ai_coagulant_init SET value=? WHERE item=?";
