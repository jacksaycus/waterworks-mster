...
public class AiSedimentationInitDAOImpl implements IAiProcessInitDAO
{
    ...
    {
        String strQuery ="SELECT * FROM ai_sedimentation_init";
    ...
    {
        String strQuery = "SELECT * FROM ai_sedimentation_init WHERE item=?";
        try
        {
    ...
    {
        String strQuery = "UPDATE ai_sedimentation_init SET value=? WHERE item='e_operation_mode'";
    ...
    {
        String strQuery = "UPDATE ai_sedimentation_init SET value=? WHERE item=?";
