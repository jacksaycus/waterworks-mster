...
public class AiGacRealtimeDAOImpl implements IAiGacRealtimeDAO
{
    ...
    {
        String strQuery = "SELECT * FROM ai_gac_realtime " +
    ...
    {
        String strQuery = "SELECT * FROM ai_gac_realtime ORDER BY update_time DESC LIMIT 1";
        try
        {
    ...
    {
        String strQuery = "DELETE FROM ai_gac_realtime WHERE update_time < ?";
